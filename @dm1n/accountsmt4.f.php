...
$tqry="
		SELECT a.*, b.cid
		FROM g_member a
		LEFT JOIN ( SELECT userid, COUNT(id) cid FROM g_extroakun WHERE status='1' GROUP BY userid) b ON a.userid = b.userid
...
<tr class="tContent<?php if(($x-1)%2) echo ' genap';?>" >
    ...
    <span style="font-size: 10px; font-style: italic;"><?php echo $row["xpass"];?> / <?php echo $row["xpass2"];?></span><?php } ?>
    -->
    </td>
    ...
    <td style="text-align:center;">
        <a href="javascript:void(0);" title="<?php echo T_("Edit");?>"  class="tbutton submission" onclick="edit('<?php echo $row["userid"]; ?>')">&nbsp;</a>
