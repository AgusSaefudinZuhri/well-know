...
function dwdHist(pfilter, vfilter, mfilter, nfilter) {
		window.open('xls.wdhist.php?pf='+pfilter+'&vf='+vfilter+'&mf='+mfilter+'&nf='+nfilter, '_blank');
}
...
function cari(x) {
	...
	if(cekzzz()) {	
		...
		var	fCari	= encodeURI( 'wdhist.f.php?pg='+x+'&pf='+pfilter+'&vf='+vfilter+'&mf='+mfilter+'&nf='+nfilter );
...
function tDownload() {
		...
		var pfilter=$("#pfilter").val();	
		var vfilter=$("#vfilter").val();	
	var	fDownload	= encodeURI('xls.wdhist.php?pf='+pfilter+'&vf='+vfilter+'&mf='+mfilter+'&nf='+nfilter );	
