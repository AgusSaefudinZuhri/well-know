...
<span style="font-size: 16px; font-weight: bold;"><?php echo strtoupper(T_("Edit Service")); ?></span>
...
<tbody>
	<tr>
		...
		<td><input class="default" id="nmjfinance" name="nmjfinance" type="text" style="width: 300px;" value="<?php echo $row["nmjfinance"];?>" required /></td>
	</tr>
	...
	<tr>
		...
		<td style="vertical-align: middle;">:</td>
		<td><input class="default" id="wkproses" name="wkproses" type="text" style="width: 300px;" value="<?php echo $row["wkproses"];?>" required /></td>
	</tr>

	<tr>
		<td style="width: 150px; vertical-align: middle;"><?php echo T_("Comission"); ?></td>	
		<td style="vertical-align: middle;">:</td>
		<td><input class="default" id="vlkomisi" name="vlkomisi" type="text" style="width: 300px;"  value="<?php echo $row["vlkomisi"];?>" required /></td>
	</tr>

	<tr>
		<td style="width: 150px; vertical-align: middle;"><?php echo T_("Acc. Name"); ?></td>	
		<td style="vertical-align: middle;">:</td>
		<td><input class="default" id="nmakun" name="nmakun" type="text" style="width: 300px;"  value="<?php echo $row["nmakun"];?>" /></td>
	</tr>

	<tr>
		<td style="width: 150px; vertical-align: middle;"><?php echo T_("Acc. No"); ?></td>	
		<td style="vertical-align: middle;">:</td>
		<td><input class="default" id="noakun" name="noakun" type="text" style="width: 300px;" value="<?php echo $row["noakun"];?>" /></td>
	</tr>

	<tr>
		<td style="width: 150px; vertical-align: middle;"><?php echo T_("Branch"); ?></td>	
		<td style="vertical-align: middle;">:</td>
		<td><input class="default" id="cabakun" name="cabakun" type="text" style="width: 300px;" value="<?php echo $row["cabakun"];?>" /></td>
	</tr>
	...
	<tr>
		...
		<td style="vertical-align: middle;">:</td>
		<td><input class="default" id="thumblink" name="thumblink" type="text" style="width: 300px;" value="<?php echo $row["thumblink"];?>" readonly required /> <a class="tbutton tsearch" href="javascript: void(0);" onclick="$('#fimage').click()">&nbsp;</a></td>
	</tr>

	<tr>
		<td style="width: 150px; vertical-align: middle;"></td>	
		<td style="vertical-align: middle;"></td>
		<td><div id="thumbdiv"><?php if($row["thumblink"]!='') { ?><img  src="<?php echo $row["thumblink"];?>" style="width: <?php echo $thumbproduk_width;?>px;height: <?php echo $thumbproduk_height;?>px;" /><?php } ?></div></td>
	</tr>
...
<script>
    ...
    {
       $("#add_post").ajaxForm({
       url:'jfinance.act.php?a=1&id=<?php echo $_GET["id"];?>',
       type:'post',
