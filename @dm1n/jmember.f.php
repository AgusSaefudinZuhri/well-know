...
if(isset($_GET["pg"])) $limit=" ORDER BY rank ASC LIMIT ".(($_GET["pg"]-1)*$perpage).",".$perpage; 
else $limit=" ORDER BY rank ASC LIMIT 0,".$perpage;

if(isset($_GET["pf"])) {
	switch($_GET["pf"]) {
	case "1": $where=" AND a.nmjmember like '%".$_GET["vf"]."%'"; break;
	}
}
...
<td style="width: 200px; text-align:center;"><?php echo T_("Managers");?></td>
<td style="width:  50px; text-align:center;"><?php echo T_("Rank");?></td>
<td style="width: 150px; text-align:center;"><?php echo T_("Requirement");?></td>
<td style="width: 100px; text-align:center;"><?php echo T_("Status");?></td>
<td style="width: 100px; text-align:center;"></td>
</tr>
<?php 
$tqry="SELECT a.* FROM g_jmember a WHERE a.status IN ('0', '1') ".$where;
...
<td style="text-align:center;"><img src="<?php echo $row["iconlink"]; ?>" style="height: 25px; display: inline-block; vertical-align: middle;" />&nbsp;
	<span style=""><?php echo $row["nmjmember"]; ?></span></td>
<td style="text-align:center;"><?php echo $row["rank"]; ?></td>
<td style="text-align:center;"><?php echo $row["reqscript"]; ?></td>
