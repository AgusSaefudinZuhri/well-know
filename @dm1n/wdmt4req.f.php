...
<td style="width: 150px; text-align:center;"><?php echo T_("in");?> <?php echo $dcurrency; ?></td>
<td style="width: 100px; text-align:center;"><?php echo T_("Estimated in Currency");?></td>
...
$tqry="
		...
		WHERE a.jtransaksi='1' AND a.jtransaksix = '0' AND a.status='0'
		 ".$where."
		 ";
...
<td style="text-align:center;"><?php echo $row["kursid"].' '.number_format($row["fintrxvalue"]*$row["excbuy"],2);?></td>
