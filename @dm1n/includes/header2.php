...
<div id="header-page">
<div id="header-logo">
<a href="<?php echo $website; ?>/c/" style="font-size: 24px; text-decoration: none;">AKUNTINGKU</a> <span style="font-size: 14px;">MANAGEMENT SYSTEM</span></div>
<div style="float: right; margin-right: 10px;">
<?php
if (isset($_SESSION['username'], $_SESSION['userid'])) {
?>
<a href="javascript:void(0)" onclick="tab2('profile',this)"><?php echo $_SESSION['username']; ?></a> | <a href="logout.php">logout</a>
<?php } ?>
</div>
</div>
</div>
