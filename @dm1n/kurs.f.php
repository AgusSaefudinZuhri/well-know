...
if(isset($_GET["pf"])) {
	switch($_GET["pf"]) {
	case "1": $where	.= " AND a.id like '%".$_GET["vf"]."%'"; break;
	}
}
...
<tr class="tHeader">
<td style="width:  25px !important; text-align:center;"><?php echo T_("ID");?></td>
<td style="width: 125px; text-align:center;"><?php echo T_("Currency");?></td>
...
<tr class="tContent<?php if(($x-1)%2) echo ' genap';?>" >
    ...
    <td style="text-align:left; "><span style=""><?php echo $row["nmkurs"]; ?></span></td>
    <td style="text-align:center;vertical-align: middle;"><?php echo number_format($row["excbuy"],2); ?></td>
    <td style="text-align:center;vertical-align: middle;"><?php echo number_format($row["excsell"],2); ?></td>
