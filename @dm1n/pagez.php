...
?></div>
<?php if($stDownload=='1' and $numRows>'0') { ?><div style="float: right; margin-top: -20px;"><a href="javascript: void(0);" class="tbutton" onclick="tDownload()"><?php echo T_("Download");?></a></div><?php } ?>