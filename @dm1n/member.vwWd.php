...
//		var vfilter=$("#vfilter").val();
		var	fCari	= encodeURI( 'member.vwWd.f.php?id=<?php echo $_GET["id"];?>&pg='+x );		
...
<span style="font-size: 16px; font-weight: bold;"><?php echo strtoupper(T_("Withdrawal History")); ?></span>
