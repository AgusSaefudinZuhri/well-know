...
//		var vfilter=$("#vfilter").val();
		var	fCari	= encodeURI( 'member.vwSponsor.f.php?id=<?php echo $_GET["id"];?>&pg='+x );		
...
$tTxt = "
	SELECT 
		(sum(if(jtransaksi = '0' AND jkomisi='1', a.idrvalue, '0'))) jnilai,
		b.nmmember
	FROM g_wfund a
...
<br/>
	...
	<div id="xiwrapper">
	<?php include('member.vwSponsor.f.php'); ?>
    </div>
