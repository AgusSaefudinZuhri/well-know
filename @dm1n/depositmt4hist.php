...
function ddepositmt4Hist(pfilter, vfilter, mfilter, nfilter) {
		window.open('xls.depositmt4hist.php?pf='+pfilter+'&vf='+vfilter+'&mf='+mfilter+'&nf='+nfilter, '_blank');
}
...
function cari(x) {
	...
	if(cekzzz()) {	
		...
		var	fCari	= encodeURI( 'depositmt4hist.f.php?pg='+x+'&pf='+pfilter+'&vf='+vfilter+'&mf='+mfilter+'&nf='+nfilter );
...
function tDownload() {
		...
		var pfilter=$("#pfilter").val();	
		var vfilter=$("#vfilter").val();	
	var	fDownload	= encodeURI('xls.depositmt4hist.php?pf='+pfilter+'&vf='+vfilter+'&mf='+mfilter+'&nf='+nfilter );	
...
<div id="iwrapper">
<?php include('depositmt4hist.f.php'); ?>
<br/>
</div>
</div>
