...
<span style="font-size: 16px; font-weight: bold;"><?php echo strtoupper(T_("Add Rate")); ?></span>
...
<tr>
    ...
    <td><input class="default" id="negara" name="negara" type="text" style="width: 300px;" required /></td>
</tr>

<tr>
    <td style="width: 150px; vertical-align: middle;"><?php echo T_("Sell"); ?></td>	
    <td style="vertical-align: middle;">:</td>
    <td><input class="default" id="jual" name="jual" type="text" style="width: 300px;" onchange="cNumber(this, '2');" required /></td>
</tr>

<tr>
    <td style="width: 150px; vertical-align: middle;"><?php echo T_("Buy"); ?></td>	
    <td style="vertical-align: middle;">:</td>
    <td><input class="default" id="beli" name="beli" type="text" style="width: 300px;" onchange="cNumber(this, '2');" required /></td>
</tr>
