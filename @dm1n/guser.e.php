...
<span style="font-size: 16px; font-weight: bold;"><?php echo strtoupper(T_("Edit Group")); ?></span>
...
<tr>
    <td style="width: 100px; vertical-align: middle;"><?php echo T_("Group Name"); ?></td>	
...
<tr>
    ...
    <td style="vertical-align: middle;">:</td>
    <td>
    	<input class="default" id="keterangan" name="keterangan" type="text" style="width: 300px;" value="<?php echo $row["keterangan"];?>" required />
    <td>
</tr>
...
$(document).ready(function() {
	$("#add_post").ajaxForm({
	url:'guser.act.php?a=1&id=<?php echo $_GET["id"];?>',
	type:'post',
