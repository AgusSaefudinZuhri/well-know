...
$qry1=mysqli_query("
	...
	WHERE masukdt BETWEEN '".$dari."' AND '".$sampai."' ".$where." ORDER BY masukdt ASC");
...
<td width="75" style="text-align:center;">Kode</td>
<td width="75" style="text-align:center;">Bentuk Berkas</td>
<td width="75" style="text-align:center;">Tgl. Masuk</td>
<td width="200" style="text-align:center;">Instansi</td>
<td width="200" style="text-align:center;">Unit</td>
<td width="200" style="text-align:center;">Masalah</td>
<td width="100" style="text-align:center;">Indeks</td>
</tr>
';
$x=1;
...
<td style="text-align:center;">'.date('d M Y', strtotime($row["masukdt"])).'</td>
...
$echo=$echo.'</table>';
$echo='LAPORAN ARSIP MASUK<br/>APLIKASI E-ARSIP<br/>DINAS BANGUNAN KABUPATEN BEKASI<br/><br/>'.$echo;
