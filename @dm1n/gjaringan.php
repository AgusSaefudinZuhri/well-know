...
$childlink = '../images/icon/child.png';
...
$user0Txt = "SELECT 
	   ...
	   a.parentstatus,
	   d.parentid pupline,
	   ifnull(sum(if(b.uplposisi='ki', '1','0')),'0') jki, 
	   ifnull(sum(if(b.uplposisi='ka', '1','0')),'0') jka, 
...
if(isset($_GET["id"]) and $user0["root"]!='1') 
$prm0="gjaringan.php?id=".$user0["pupline"]; 
else $prm0="";
...
<?php echo T_("Cari Member"); ?>: <input type="text" class="default blacktransparent" id="prmc" /> <a href="javascript: void(0);" class="tbutton tsearch " onclick="zjaringan();" style="line-height: 1;">&nbsp;</a><br/>
</div>
...
<div class="row">
	<div class="col-lg-12">
<div id="infojaringan" class="blacktransparent" style="margin-top: 10px; text-align: center;">
...
<a href="javascript: void(0);" onclick="loadpagez('<?php echo 'gjaringan.php?id='.$sp["parentid"]; ?>&a1=gjaringan.php')" class="blacktransparent" style=" font-weight: bold; padding: 5px; text-decoration: none; margin: 5px auto; clear: both; font-size: 12px;" ><?php echo T_('Ke Upline Langsung');?></a>
&nbsp;&nbsp;

	<a href="javascript: void(0);" onclick="loadpagez('<?php echo 'gjaringan.php?id='.$_SESSION["userid"]; ?>')" class="blacktransparent" style=" font-weight: bold; padding: 3px; text-decoration: none; margin: 5px auto; clear: both; font-size: 12px;" ><?php echo T_('Kembali ke ');?> <?php echo $_SESSION["userid"]; ?></a>
    <br/><br/><br/>
