...
<span style="font-size: 16px; font-weight: bold;"><?php echo strtoupper(T_("Add Managers")); ?></span>
...
<tr>
	...
	<td><input class="default" id="jmemberid" name="jmemberid" type="text" style="width: 100px;" required /></td>
</tr>

<tr>
	<td style="width: 150px; vertical-align: middle;"><?php echo T_("Managers"); ?></td>	
	<td style="vertical-align: middle;">:</td>
	<td><input class="default" id="nmjmember" name="nmjmember" type="text" style="width: 300px;" required /></td>
</tr>

<tr>
	<td style="width: 150px; vertical-align: middle;"><?php echo T_("Rank"); ?></td>	
	<td style="vertical-align: middle;">:</td>
	<td><input class="default" id="rank" name="rank" type="text" style="width: 300px;" onchange="cNumber(this,'0')" required /></td>
</tr>

<tr>
	<td style="width: 150px; vertical-align: middle;"><?php echo T_("Requirement Script"); ?></td>	
	<td style="vertical-align: middle;">:</td>
	<td><input class="default" id="reqscript" name="reqscript" type="text" style="width: 300px;" required /></td>
</tr>
