...
//		var vfilter=$("#vfilter").val();
		var	fCari	= encodeURI( 'exchange.f.php?pg='+x );		
 ...
 <div class="row">
	<div class="col-lg-12">
		<div class="page-header"><?php echo T_("Exchange Rate");?></div>
	</div>
</div>
<style>
...
<!--<p><i class="fa fa-table"></i> Commisions History Records</p> -->

	<div id="iwrapper">
	<?php include('exchange.f.php'); ?>
    </div>
