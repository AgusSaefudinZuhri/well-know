<?php
	...
	switch( $_GET["a"] ) {
		...
		case "0" :
			...
			$txt		= "SELECT * FROM g_tiket WHERE id = '".$_GET["id"]."'";
			$qry		= mysql_query( $txt );
...
//				echo $insTxt1. " ". $insTxt2;
				...
				else echo 'Terjadi kesalahan proses. Bila masalah berlanjut, mohon menghubungi Administrator';
