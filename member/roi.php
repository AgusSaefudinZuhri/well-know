...
$funds=mysql_fetch_array(mysql_query("
	...
	FROM g_komisi a
	WHERE a.userid='".$_SESSION["userid"]."' AND a.status IN ('0','1') AND a.jkomisi='3'
	"));
...
//		var vfilter=$("#vfilter").val();
		var	fCari	= encodeURI( 'roi.f.php?pg='+x );		
 ...
 <div class="row">
	<div class="col-lg-12">
		<div class="page-header"><?php echo T_("ROI Wallet");?></div>
	</div>
</div>
<style>
...
<p>Total ROI: <?php echo $syscurrency." ".number_format( $funds["jnilai"],2 ); ?></p>
...
<p><i class="fa fa-table"></i> ROI Transfer History</p>

	<div id="iwrapper">
	<?php include('roi.f.php'); ?>
    </div>
