...
//		var vfilter=$("#vfilter").val();
		var	fCari	= encodeURI( 'lotsBonus.h.f.php?pg='+x );		
 ...
 <div class="row">
	<div class="col-lg-12">
		<div class="page-header"><?php echo T_("Lots Rebate History Records");?></div>
	</div>
</div>
<style>
...
<p><i class="fa fa-table"></i> Lots Rebate History Records</p>

	<div id="iwrapper">
	<?php include('lotsBonus.h.f.php'); ?>
    </div>
			</div>
	</section>
</div>
