...
//include_once('includes/config.php');
		...
		//echo print_r($jpackage[$jpackageIni]).'<br/>';
			...
			while( $uniRow = mysqli_fetch_array( $uniQry ) ) {
				...
				$trxvalue = $jLot * $junilevel[$uniIni]["rbt".sprintf('%02d', $uniRow["unplreverse"])];
		...
		if($tEcho=='1') {
			if($tError==0) echo 'bn.unilevellots.php Successed<br/>';
			else echo 'bn.unilevellots.php Failed<br/>';
		}
