...
//		var vfilter=$("#vfilter").val();
		var	fCari	= encodeURI( 'devbonus.f.php?pg='+x );		
 ...
 <div class="row">
	<div class="col-lg-12">
		<div class="page-header"><?php echo T_("Development Bonus Wallet");?></div>
	</div>
</div>
<style>
...
<p>Total Bonus: <?php echo $syscurrency." ".number_format( $funds["jnilai"],2 ); ?></p>
...
<p><i class="fa fa-table"></i> Development Bonus Transfer History</p>

	<div id="iwrapper">
	<?php include('devbonus.f.php'); ?>
    </div>
...
<script>
    $(document).ready(function() 
    {
       ...
       $("#add_post").ajaxForm({
       url:'transfer.act.php?a=2&k=2&id=<?php echo $_SESSION["userid"];?>',
       type:'post',
