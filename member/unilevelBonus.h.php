...
//		var vfilter=$("#vfilter").val();
		var	fCari	= encodeURI( 'unilevelBonus.h.f.php?pg='+x );		
 ...
 <div class="row">
	<div class="col-lg-12">
		<div class="page-header"><?php echo T_("Unilevel Bonus History Records");?></div>
	</div>
</div>
<style>
...
<p><i class="fa fa-table"></i> Unilevel Bonus History Records</p>

	<div id="iwrapper">
	<?php include('unilevelBonus.h.f.php'); ?>
    </div>
			</div>
	</section>
</div>
