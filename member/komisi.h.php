...
//		var vfilter=$("#vfilter").val();
		var	fCari	= encodeURI( 'komisi.h.f.php?pg='+x );		
 ...
 <div class="row">
	<div class="col-lg-12">
		<div class="page-header"><?php echo T_("Profit Sharing History Records");?></div>
	</div>
</div>
<style>
...
<p><i class="fa fa-table"></i> Profit Sharing History Records</p>

	<div id="iwrapper">
	<?php include('komisi.h.f.php'); ?>
    </div>
			</div>
	</section>
</div>
