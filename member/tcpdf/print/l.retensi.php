...
$qry1=mysql_query("
	...
	WHERE retensi='1' AND rdate BETWEEN '".$dari."' AND '".$sampai."' ".$where." ORDER BY masukdt ASC");
...
<td width="75" style="text-align:center;">Tgl. Retensi</td>
...
<td style="text-align:center;">'.date('d M Y', strtotime($row["rdate"])).'</td>
...
$echo=$echo.'</table>';
$echo='LAPORAN RETENSI ARSIP<br/>APLIKASI E-ARSIP<br/>DINAS BANGUNAN KABUPATEN BEKASI<br/><br/>'.$echo;
