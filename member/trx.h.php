...
//		var vfilter=$("#vfilter").val();
		var	fCari	= encodeURI( 'trx.h.f.php?pg='+x );		
 ...
 <div class="row">
	<div class="col-lg-12">
		<div class="page-header"><?php echo T_("Finance Transaction");?></div>
	</div>
</div>
<style>
...
<p><i class="fa fa-table"></i> Finance Transactions</p>

	<div id="iwrapper">
	<?php include('trx.h.f.php'); ?>
    </div>
			</div>
	</section>
