<?php 
 ...
 <div class="row">
	<div class="col-lg-12">
		<div class="page-header"><?php echo T_("Withdrawal");?></div>
	</div>
</div>
<style>
...
<script>
    ...
    $(document).ready(function() 
    {
       ...
       $("#add_post4").ajaxForm({
       url:'deposit.act.php?a=1&id=<?php echo $_SESSION["userid"];?>&fid=<?php echo $_GET["id"];?>',
       type:'post',
	   beforeSubmit: function () {
		...
		//		alert(hasil);
			if(hasil=="success") {
				$.messager.alert( sucProc(), "<?php echo T_("Your Withdrawal Request is Submited");?>!!!","info");
