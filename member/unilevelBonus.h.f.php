...
<td style="width: 100px; text-align:center;"><?php echo T_("Unilevel Bonus");?></td>
...
$tqry="
	...
	WHERE a.userid =  '".$_SESSION["userid"]."' AND a.jtransaksi='0' AND a.jkomisi  IN ('3', '6') ".$where;
...
<td style="text-align:center;"><?php if($row["jkomisi"]=='6') echo $row["remark"];?></td>
