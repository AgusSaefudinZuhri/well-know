...
//		var vfilter=$("#vfilter").val();
		var	fCari	= encodeURI( 'roi.h.f.php?pg='+x );		
 ...
 <div class="row">
	<div class="col-lg-12">
		<div class="page-header"><?php echo T_("ROI History Records");?></div>
	</div>
</div>
<style>
...
<p><i class="fa fa-table"></i> ROI History Records</p>

	<div id="iwrapper">
	<?php include('roi.h.f.php'); ?>
    </div>
