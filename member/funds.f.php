...
<td style="width: 50px; text-align:center;"><?php echo T_("Name");?></td>
<td style="width: 50px; text-align:center;"><?php echo T_("Amount");?></td>
<td style="width: 50px; text-align:center;"><?php echo T_("Date");?></td>
<td style="width: 125px; text-align:center;"><?php echo T_("Type");?></td>
</tr>
...
$tqry="
	...
	FROM g_wfund a
	WHERE a.userid =  '".$_SESSION["userid"]."' AND a.jtransaksi='1' AND a.jtransaksix='1' ".$where;
...
<td style="text-align:left;"><?php echo $row["userid"];?></td>
<td style="text-align:left;"><?php echo $syscurrency." ".number_format( $row["trxvalue"],2 );?></td>
...
<td style="text-align:center;"><?php 
	switch($row["jtransaksi"]) {
		case "0": echo "Receive"; break;
		case "1": echo "Send"; break;
	}
	 ?></td>
</tr>
<?php $x++; } ?>
